...
@ViewController
@PreviousView("/system/maintainRoleDetail.xhtml")
@NextView("/system/maintainRoleDetail.xhtml")
public class MaintainRoleDetailMB extends AbstractEditPageBean<Role, String> {
